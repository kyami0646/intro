    ...
    return (
        <HeaderLayout>
                ...
                <Accordion allowMultiple mx="auto" w={{base:"90%",md:"80%"}} mt={12}>
                    ...
                    description="業務や勉強会などを通じて基本的な技術を学んだ上で、最終的にはプロダクトマネージャーとして働きたいと思っています。
                    技術力を基盤に、自分が携わる分野の専門知識はもちろん、その他ビジネススキルも備えた技術者になりたいです。
                    理由としては、プロダクトの開発工程全てに関わり、改善点などを提案できるようになりたいからです。
                    そのためには高い技術力と、ビジネススキルを有している必要があるので、絶えず技術力を吸収し続け、ユーザーの生活が便利で豊かになるようなWebアプリを開発したいと考えています。
